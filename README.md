...
|Команда ответственная за мониторинг проведения мероприятия|Работоспособность платформы|Низкий|Низкий|
|Команда ответственная за модерацию мероприятия|Соблюдение правил платформы|Низкий|Низкий|
|Целевая аудитория (слушатели из IT сферы, с территории РФ, потенциальные соискатели работы, студенты)|Обмен знаниями, получение предложений по работе, новые контакты, мерч|Низкий|Высокий|
|Потенциальные инвесторы, партнеры|Новые идеи, потенциальные бизнес интеграции, инвестиции|Низкий|Высокий|
|Рекламодатели|Целевой трафик|Низкий|Высокий|
|Рецензенты докладов и программы конференции|Качество информации|Высокий|Низкий|
|Отвественные за рекламу мероприятия|Количество посетителей|Высокий|Низкий|
|Партнеры (предоставление оборудования)|Доход от аренды|Высокий|Низкий|
|Конкурирующие конференции|Целевая аудитория|Высокий|Низкий|
|Ведущие и операторы мероприятия|Фокус аудитория|Высокий|Низкий|
|Интернет провайдер|Доход от обеспечения пропускной способности|Высокий|Низкий|
...
| Сертификаты | Документы, которые участники могут получить после успешного прохождения тестирования или обучения на конференции |
