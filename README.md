...
|Рекламодатели|Целевой трафик|Высокий|Низкий|
...
|Маркетологи|Количество посетителей|Высокий|Высокий|
...
- [ADR.001 Определение категории системы (ACID|BASE|CA|PACELC)](adr/adr-001-category.md)
- [ADR.002 Опредение шаблона интеграции (метод, структура, взаимодействие)](adr/adr-002-integration.md)
