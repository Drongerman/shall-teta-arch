...
Rel(app, user_mgmt_srv, "HTTP/REST")
Rel(app, event_mgmt_srv, "HTTP/REST")
Rel(app, lecture_mgmt_srv, "HTTP/REST")
Rel(app, advert_mgmt_srv, "HTTP/REST")
Rel(app, schedule_mgmt_srv, "HTTP/REST")
Rel(app, interaction_srv, "WebSocket")
Rel(app, support_mgmt_srv, "HTTP/REST")
Rel(app, stream_mgmt_srv, "HTTP/REST")
Rel(app, streaming_service, "WebSocket")
...
Rel(user_mgmt_srv, user_db, "JDBC, SQL")
Rel(event_mgmt_srv, event_db, "JDBC, SQL")
Rel(lecture_mgmt_srv, lecture_db, "JDBC, SQL")
Rel(advert_mgmt_srv, advert_db, "JDBC, SQL")
Rel(billing_mgmt_srv, billing_db, "JDBC, SQL")
Rel(stream_mgmt_srv, stream_db, "JDBC, SQL")
Rel(interaction_srv, interaction_db, "NOSQL")
Rel(schedule_mgmt_srv, schedule_db, "JDBC, SQL")
...
Rel(tg_notify_srv, tg_notify_srv_db, "JDBC, SQL")
Rel(email_notify_srv, email_notify_srv_db, "JDBC, SQL")

Rel(tg_notify_srv, tg, "JDBC, SQL")
Rel(email_notify_srv, email, "JDBC, SQL")
Rel(support_mgmt_srv, email, "JDBC, SQL")
