...
Boundary(access_ctx, "Доступ", "Управление доступом и ролями") {
...
Boundary(user_ctx, "Пользователи") {
...
Boundary(event_ctx, "Конференции") {   
...
Boundary(schedule_ctx, "Расписание") {
...
Boundary(notification_ctx, "Уведомления") {
...
Boundary(translation_ctx, "Трансляция") {
...
Boundary(interaction_ctx, "Интерактив") {
