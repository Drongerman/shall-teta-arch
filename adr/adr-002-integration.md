...
### Протокол:
  * REST - быстро и просто управлять объектами, популярный, но менее производительный
    * Гибкость - 8
    * Популярность - 10
    * Простота использования - 10
    * Производительность - 7
  * gRPC - более гибкий протокол, но меньше специалистов на рынке, вероятно необходимо потратить время на обучение
    * Гибкость - 9
    * Популярность - 7
    * Простота использования - 7
    * Производительность - 9
  * GraphQL - сложнее делать бэк, фронт более гибкий, независимый, меньше специалистов на рынке, вероятно необходимо потратить время на обучение
    * Гибкость - 10
    * Популярность - 8
    * Простота использования - 7
    * Производительность - 8
  * EDA - сложнее делать бэк, позволит обеспечить BASE, меньше специалистов на рынке, вероятно необходимо потратить время на обучение
    * Гибкость - 7
    * Популярность - 6
    * Простота использования - 6
    * Производительность - 8
  * WebSocket - отлично для выполнения онлайн функций в реальном времени
    * Гибкость - 8
    * Популярность - 7
